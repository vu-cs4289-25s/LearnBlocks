            ...
            >
              <div className="flex items-center justify-between">
                ...
                <p>
                  ...
                  {course.modules.map((module, key) => <text key={key}>{module + ' '}</text>)}
                </p>
                </div>
                <Link
                  to={`/catalog/${course.course_id}`}
                  className="self-center rounded outline-amber-400 px-4 py-2 text-sm font-medium outline hover:bg-amber-400 hover:text-black active:bg-amber-500"
                >
                  View Modules
                </Link>
              </div>
